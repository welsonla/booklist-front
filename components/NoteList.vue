        ...
        <div class="flex flex-row py-4 border-b border-gray-200" :key="`note-`+note.id">
          ...
          <div class="flex flex-col flex-1 text-sm text-gray-500 ml-4">
            ...
            <div class="text-slate-400 text-sm leading-8">
              <a :href="`/user/`+note.author_id" class="hover:bg-orange-300 text-blue-400">{{ note.author.name }}</a> 评论 <a :href="`/book/`+note.book_id" class="hover:bg-orange-300 text-blue-400"> {{ note.book.name }}</a></div>
