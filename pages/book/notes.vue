...
export default {
  name: 'reviews',
  components: {NoteItem, UserItem, BookItem, ReviewItem, Layout},
  async fetch() {
    if(this.userid > 0) {
    ...
    await api.notes(params).then((resp) => {
